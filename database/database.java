...
class database{
    ...
    public static void addCustomer(String name, String address, String email, int phone, String password){
        try{
            Connection con=connect();
            PreparedStatement stmt=con.prepareStatement("insert into customer(name,address,email,phone,password) values(?,?,?,?,?)");
